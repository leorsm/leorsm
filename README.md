...
**Aspiring Software Engineer — Student @ 42**

*Career changer with a passion for building things from scratch.*
...
I thrive in environments that challenge me, and I'm not afraid to start from zero.
...
**42** — Common Core *(2026 — present)*
> Peer-to-peer, project-based engineering school. No teachers, no lectures — just problem solving, collaboration, and code.

**CS50x** — Harvard University *(via edX)*
> Introduction to Computer Science — algorithms, data structures, C, Python, SQL, web fundamentals.
...
I'm drawn to **low-level programming** and understanding what happens under the hood. I want to build software that is clean, efficient, and purposeful — and I'm just getting started.

Open to **internship opportunities** and always happy to connect.

---

<div align="center">

📍 France &nbsp;|&nbsp; 🏫 42 &nbsp;|&nbsp; 📬 [leratsam@learner.42.tech](mailto:leratsam@learner.42.tech)
